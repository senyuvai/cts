...
/*FirmaEgitimci Module*/
Route::get('firmaegitimciler','FirmaEgitimcilerController@firmaegitimciler');
Route::post('firmaegitimciler/add','FirmaEgitimcilerController@addFirmaEgitimci');
Route::get('firmaegitimciler/delete/{id}','FirmaEgitimcilerController@deleteFirmaEgitimci');
Route::post('firmaegitimciler/update','FirmaEgitimcilerController@updateFirmaEgitimci');
...
/*Muayene Module*/
Route::get('muayeneturler','MuayeneTurController@muayeneturler');
Route::post('muayeneturler/add','MuayeneTurController@addMuayeneTur');
Route::get('muayeneturler/delete/{id}','MuayeneTurController@deleteMuayeneTur');
Route::post('muayeneturler/update','MuayeneTurController@updateMuayeneTur');




/*EgitimFİrma Module*/
Route::get('egitimfirmalari','EgitimFirmaController@egitimfirmalari');
Route::post('egitimfirmalari/add','EgitimFirmaController@addEgitimFirma');
Route::get('egitimfirmalari/delete/{id}','EgitimFirmaController@deleteEgitimFirma');
Route::post('egitimfirmalari/update','EgitimFirmaController@updateEgitimFirma');


/*Sgk Module*/
Route::get('sgklar','SgkController@sgklar');
Route::post('sgklar/add','SgkController@addSgk');
Route::get('sgklar/delete/{id}','SgkController@deleteSgk');
Route::post('sgklar/update','SgkController@updateSgk');


/*Egitim Module*/
Route::get('egitimler','EgitimController@egitimler');
Route::post('egitimler/add','EgitimController@addEgitim');
Route::get('egitimler/delete/{id}','EgitimController@deleteEgitim');
Route::post('egitimler/update','EgitimController@updateEgitim');
...
Route::post('employee/get-firmaegitimci','EmployeeController@getFirmaEgitimci');
Route::post('employee/get-trainingdate','EmployeeController@getTrainingDate');
Route::post('employee/add-bank-account','EmployeeController@addBankInfo');
Route::post('employee/add-employee-training','EmployeeController@addEmployeeTrainingInfo');
Route::post('employee/add-egitim-durum','EmployeeController@addEgitimInfo');
Route::post('employee/add-saglik-durumu','EmployeeController@addSaglikInfo');
Route::post('employee/add-yillik-izin','EmployeeController@addYillikInfo');
Route::post('employee/add-acil-durum','EmployeeController@addAcilDurumInfo');
Route::get('employee/delete-yillik-izin/{id}','EmployeeController@deleteYillikIzin');
Route::get('employee/delete-egitim-durum/{id}','EmployeeController@deleteEgitimDurum');
Route::get('employee/delete-bank-account/{id}','EmployeeController@deleteBankAccount');
Route::get('employee/delete-saglik-durumu/{id}','EmployeeController@deleteSaglikDurumu');
Route::get('employee/delete-acil-durum/{id}','EmployeeController@deleteAcilDurum');
...
Route::get('training/view-applicant/{id}','TrainingController@viewTrainingApplicant');
Route::post('training/set-applicant-details','TrainingController@setApplicantDetails');
Route::get('training/download-training-document/{id}','TrainingController@downloadTrainingDocument');
...
/*Saglik Module*/
Route::get('saglik','SaglikController@saglik');
Route::post('saglik/post-new-saglik','SaglikController@postSaglik');
Route::get('saglik/download-saglik-raporu/{id}','SaglikController@downloadSaglikRaporu');
Route::get('saglik/delete-saglik/{id}','SaglikController@deleteSaglik');
Route::get('saglik/edit/{id}','SaglikController@editSaglik');
Route::post('saglik/saglik-edit-post','SaglikController@postEditSaglik');

/*Muayene Module*/
Route::get('muayene','MuayeneController@muayene');
Route::post('muayene/post-new-muayene','MuayeneController@postMuayene');
Route::get('muayene/download-muayene-raporu/{id}','MuayeneController@downloadMuayeneRaporu');
Route::get('muayene/delete-muayene/{id}','MuayeneController@deleteMuayene');
Route::get('muayene/edit/{id}','MuayeneController@editMuayene');
Route::post('muayene/muayene-edit-post','MuayeneController@postEditMuayene');
...
Route::get('training/trainingdetails','TrainingController@trainingdetails');
Route::post('training/post-new-trainingdetail','TrainingController@postNewTrainingDetail');
Route::get('training/delete-trainingdetail/{id}','TrainingController@deleteTrainingDetail');
Route::get('training/view-trainingdetails-info/{id}','TrainingController@viewTrainingDetailsInfo');
Route::post('training/post-trainer-update-info','TrainingController@postTrainerUpdateInfo');
Route::post('training/post-trainingdetail-update-info','TrainingController@postTrainingDetailUpdateInfo');
