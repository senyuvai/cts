                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <form class="" role="form" action="{{url('employees/add-employee-post')}}" method="post">
								...
								<input type="hidden" class="form-control" value="cts" required name="password">
								<input type="hidden" class="form-control" value="cts" required name="rpassword">
