                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <td data-label="SL">@if($d->avatar!='')
                                            <img src="<?php echo asset('assets/employee_pic/'.$d->avatar); ?>" alt="Profile Page" width="50px" height="50px">
                                        @else
                                    ...
                                    @if($d->gercek_statu=='Aktif')
                                    <td data-label="Status"><p class="btn btn-success btn-xs">Aktif</p></td>
                                    @else
                                    <td data-label="Status"><p class="btn btn-warning btn-xs">Pasif</p></td>
                                    @endif
